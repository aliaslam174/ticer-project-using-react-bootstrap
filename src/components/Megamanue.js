...
export default function Megamanue() {
  return (
    <div>
  ...
  <div className="container-fluid">
    ...
    <div className="collapse navbar-collapse" id="navbarExample1">
      ...
      <ul className="navbar-nav me-auto ps-lg-0" style="padding-left: 0.15rem">
        ...
        <li className="nav-item dropdown position-static">
          ...
          <div className="dropdown-menu w-100 mt-0" aria-labelledby="navbarDropdown" style="
